...
namespace BadDetective
{
    ...
    public struct GameTime
    {
        ...
        public static GameTime Convert(float time)
        {
            ...
            int month = (int)(time / 24 / 7/ 4);
            int week = (int)(time /  24 / 7 - month*4);
            int day = (int)(time /  24  - month * 4 * 7 - week*7);
            int hour = (int)(time  - month * 4 * 7 * 24 - week * 7 *24 - day * 24);
            float minute = (time  - month * 4 * 7 * 24 - week * 7 * 24 - day * 24 - hour) * 60;
